...
define('dummy/ember-element-query/tests/addon.lint-test', [], function () {
  ...
  QUnit.test('ember-element-query/components/e-q.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-element-query/components/e-q.js should pass ESLint\n\n1:41 - Extra semicolon. (semi)\n2:49 - Extra semicolon. (semi)\n7:3 - Extra semicolon. (semi)');
  });

  QUnit.test('ember-element-query/mixins/element-query.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-element-query/mixins/element-query.js should pass ESLint\n\n');
  });

  QUnit.test('ember-element-query/mixins/event-forwarding.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-element-query/mixins/event-forwarding.js should pass ESLint\n\n');
  });
});
define('dummy/ember-element-query/tests/app.lint-test', [], function () {
  ...
  QUnit.test('ember-element-query/components/e-q.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'ember-element-query/components/e-q.js should pass ESLint\n\n1:61 - Extra semicolon. (semi)\n1:62 - Newline required at end of file but not found. (eol-last)');
  });
});
  ...
  function initialize() {
    ...
    _showdown.default.extension('hljs', function () {
      ...
      function replacement(wholeMatch, match, left, right) {
        ...
        console.log({ left: left, newLeft: newLeft });
...
define("dummy/pods/application/template", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "kgfibeSq", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[9,\"class\",\"route-application\"],[7],[0,\"\\n  \"],[1,[18,\"outlet\"],false],[0,\"\\n\"],[8]],\"hasEval\":false}", "meta": { "moduleName": "dummy/pods/application/template.hbs" } });
});
